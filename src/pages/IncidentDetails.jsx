...
function StepItem({ active, done, title, subtitle, icon: Icon, onClick }) {
  const base =
    "w-full rounded-xl border px-4 py-4 text-left transition flex items-center gap-4";
            ...
            {activeStep === "OVERVIEW" ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="hidden md:flex items-center gap-2 rounded-xl bg-sky-50 ring-1 ring-sky-200 px-4 py-2">
                ...
                <div className="rounded-xl bg-gradient-to-r from-indigo-50 via-white to-sky-50 ring-1 ring-slate-200 p-4">
                    ...
                    <div className="lg:col-span-1">
                      <Field label="Title" required error={stepErrors.title}>
                        <input
                          ...
                          className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-900 outline-none focus:border-indigo-300 focus:ring-4 focus:ring-indigo-100 disabled:bg-slate-50"
                    ...
                    <div className="lg:col-span-2 grid gap-4 md:grid-cols-2">
                      ...
                      >
                        <select
                          ...
                          className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-900 disabled:bg-slate-50"
                        >
                  ...
                  <div className="mt-4 grid gap-4 lg:grid-cols-3">
                    <div className="lg:col-span-1">
                      ...
                      >
                        <label className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 flex items-center justify-between gap-3">
                          <div>
              ...
              <div className="space-y-4">
                ...
                >
                  <textarea
                    ...
                    className="min-h-[120px] w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-900 outline-none focus:border-indigo-300 focus:ring-4 focus:ring-indigo-100 disabled:bg-slate-50"
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <Field label="Lessons learned" hint="Optional">
                    <textarea
                      ...
                      className="min-h-[100px] w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-900 outline-none focus:border-indigo-300 focus:ring-4 focus:ring-indigo-100 disabled:bg-slate-50"
                ...
                {!readOnly ? (
                  <div className="rounded-xl border border-indigo-200 bg-indigo-50/40 p-4">
                    ...
                    <textarea
                      ...
                      className="min-h-[90px] w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-900 outline-none focus:border-indigo-300 focus:ring-4 focus:ring-indigo-100"
